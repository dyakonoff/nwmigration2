...
@Entity(name = "nwtest2$Employees")
public class Employees extends BaseIntIdentityIdEntity {
    private static final long serialVersionUID = -3125249570115118238L;

    @JoinTable(name = "Employee Privileges",
        joinColumns = @JoinColumn(name = "Employee ID"),
        inverseJoinColumns = @JoinColumn(name = "Privilege ID"))
    @ManyToMany
    protected List<Privilegesnw> privilegesnw;
    ...
    public void setPrivilegesnw(List<Privilegesnw> privilegesnw) {
        this.privilegesnw = privilegesnw;
    }

    public List<Privilegesnw> getPrivilegesnw() {
        return privilegesnw;
    }
